...
namespace MGS\AdvancedReports\Model\ResourceModel\Report\Day;

class Collection extends \MGS\AdvancedReports\Model\ResourceModel\Report\Collection\DayCollection
{
    ...
    public function __construct(
        ...
        \MGS\AdvancedReports\Model\ResourceModel\Day $resource,
    ...
    protected function _beforeLoad()
    {
        ...
        $this->getSelect()->joinRight(
            ['mgs_advancedreports_dayofweek' => $this->getTable('mgs_advancedreports_dayofweek')],
            'DAYOFWEEK(created_at) = dow',
            [
                'dow',
