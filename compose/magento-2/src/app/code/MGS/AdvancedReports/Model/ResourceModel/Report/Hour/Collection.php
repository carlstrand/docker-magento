...
namespace MGS\AdvancedReports\Model\ResourceModel\Report\Hour;

class Collection extends \MGS\AdvancedReports\Model\ResourceModel\Report\Collection\HourCollection
{
    ...
    protected function _beforeLoad()
    {
        ...
        $this->getSelect()->joinRight(
            ['mgs_advancedreports_hour' => $this->getTable('mgs_advancedreports_hour')],
            'HOUR(created_at) = h',
            [
                'CONCAT(h, \':00-\', h+1, \':00\') as h',
