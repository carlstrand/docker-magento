...
namespace MGS\AdvancedReports\Model\ResourceModel\Report\Country;

class Collection extends \MGS\AdvancedReports\Model\ResourceModel\Report\Collection\CountryCollection
{
    ...
    protected function _beforeLoad()
    {
        ...
        $this->getSelect()->join(
            ...
            'main_table.billing_address_id = sales_order_address.entity_id',
            [
                'country_id',
        ...
        if (!$this->isTotals()) {
            $this->getSelect()->group('country_id');
        }
