...
namespace MGS\AdvancedReports\Block\Adminhtml\Sales\Day;

use Magento\Reports\Block\Adminhtml\Grid\AbstractGrid;

class Grid extends AbstractGrid
{
    protected $_columnGroupBy = 'dow';
    protected $_template = 'MGS_AdvancedReports::widget/grid/day/extended.phtml';
    ...
    {
        return 'MGS\AdvancedReports\Model\ResourceModel\Report\Day\Collection';
    }
    ...
    protected function _prepareColumns()
    {
        $this->addColumn(
            'dow',
            [
                'header' => __('Day Of Week'),
                'index' => 'dow',
                'sortable' => false,
                'renderer' => 'MGS\AdvancedReports\Block\Adminhtml\Sales\Grid\Column\Renderer\Day',
                'totals_label' => __('Total'),
                'html_decorators' => ['nobr'],
                'header_css_class' => 'col-day-of-week-id',
                'column_css_class' => 'col-day-of-week-id'
            ]
        );
        $this->addColumn(
            'orders_count',
        ...
        $this->addExportType('*/*/exportSalesByDayCsv', __('CSV'));
        $this->addExportType('*/*/exportSalesByDayExcel', __('Excel XML'));
