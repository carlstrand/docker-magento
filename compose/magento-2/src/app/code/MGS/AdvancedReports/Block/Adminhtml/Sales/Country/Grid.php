...
namespace MGS\AdvancedReports\Block\Adminhtml\Sales\Country;

use Magento\Reports\Block\Adminhtml\Grid\AbstractGrid;

class Grid extends AbstractGrid
{
    protected $_columnGroupBy = 'country_id';
    protected $_template = 'MGS_AdvancedReports::widget/grid/country/extended.phtml';
    ...
    {
        return 'MGS\AdvancedReports\Model\ResourceModel\Report\Country\Collection';
    }
    ...
    protected function _prepareColumns()
    {
        $this->addColumn(
            ...
            [
                ...
                'index' => 'country_id',
                'sortable' => false,
                'renderer' => 'MGS\AdvancedReports\Block\Adminhtml\Sales\Grid\Column\Renderer\Country',
                'totals_label' => __('Total'),
                'html_decorators' => ['nobr'],
                'header_css_class' => 'col-country-id',
                'column_css_class' => 'col-country-id'
            ]
        );
        $this->addColumn(
            'orders_count',
