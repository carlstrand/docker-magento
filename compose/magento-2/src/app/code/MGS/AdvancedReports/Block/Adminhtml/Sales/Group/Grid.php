...
namespace MGS\AdvancedReports\Block\Adminhtml\Sales\Group;

use Magento\Reports\Block\Adminhtml\Grid\AbstractGrid;

class Grid extends AbstractGrid
{
    protected $_columnGroupBy = 'customer_group_code';
    protected $_template = 'MGS_AdvancedReports::widget/grid/group/extended.phtml';
    ...
    {
        return 'MGS\AdvancedReports\Model\ResourceModel\Report\Group\Collection';
    }
    ...
    protected function _prepareColumns()
    {
        $this->addColumn(
            ...
            [
                ...
                'header_css_class' => 'col-customer-group-code',
                'column_css_class' => 'col-customer-group-code'
            ]
        );
        $this->addColumn(
            'orders_count',
        ...
        $this->addExportType('*/*/exportSalesByGroupCsv', __('CSV'));
        $this->addExportType('*/*/exportSalesByGroupExcel', __('Excel XML'));
