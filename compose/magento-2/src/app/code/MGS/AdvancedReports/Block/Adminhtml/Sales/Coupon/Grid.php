...
namespace MGS\AdvancedReports\Block\Adminhtml\Sales\Coupon;
...
class Grid extends AbstractGrid
{
    ...
    protected $_template = 'MGS_AdvancedReports::widget/grid/coupon/extended.phtml';
    ...
    {
        return 'MGS\AdvancedReports\Model\ResourceModel\Report\Coupon\Collection';
    }
    ...
    protected function _prepareColumns()
    {
        $this->addColumn(
            ...
            [
                ...
                'index' => 'coupon_code',
                'renderer' => 'MGS\AdvancedReports\Block\Adminhtml\Sales\Grid\Column\Renderer\Coupon',
                'sortable' => false,
                'totals_label' => __('Total'),
                'html_decorators' => ['nobr'],
                'header_css_class' => 'col-coupon-code',
                'column_css_class' => 'col-coupon-code'
            ]
        );
        $this->addColumn(
            'orders_count',
